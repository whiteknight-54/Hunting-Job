...
**STRICT JSON SCHEMA (enforced server-side before PDF generation):**
{
  ...
  "experience": [
    {
      "title": "string (optional; company/dates come from profile)",
      "details": ["Bullet string 1", "Bullet string 2"]
    }
  ]
}
Rules:
- Root keys ONLY: title, summary, skills, experience.
- skills: object with ≥1 category; each value = non-empty string array.
- experience: non-empty array; length should match profile work history when provided.
