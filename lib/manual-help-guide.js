...
export const MANUAL_HELP_SECTIONS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Build & copy — uses job description, profile base, pasted resume JSON, and optional questions (role title and company name are not injected into these prompts).",
    ],
  },
  {
    id: "profile",
