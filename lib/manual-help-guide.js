...
export const MANUAL_HELP_SECTIONS = [
  ...
  },
  {
    ...
    bullets: [
      "Role title — used only for the downloaded PDF filename (Step 2).",
      "Company name — used only for the downloaded PDF filename (Step 2).",
      "Job description — full JD text for ATS tailoring and step 3 prompts.",
      "Optional: employer / application questions — passed into ATS job context and step 3 prompts.",
    ],
  },
  {
    id: "step1",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Build & copy — uses job description, one merged tailored resume block, and optional questions (role title and company name are not injected into these prompts).",
    ],
  },
  {
    id: "profile",
