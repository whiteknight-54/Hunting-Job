...
export const MANUAL_HELP_SECTIONS = [
  ...
  },
  {
    ...
    note: "Profile data is loaded from resumes/{name}.json. You can add extra fields anytime — they are included in step 3 as full profileJson.",
  },
  {
    id: "step2",
    title: "Step 2 — PDF",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Build & copy — sends JD, role, company, questions, full profile JSON, and pasted resume JSON.",
    ],
  },
  {
    id: "profile",
    ...
    paragraphs: [
      "resumes/*.json is an open schema: add certifications, languages, skills, projects, screening defaults, notes, or any custom keys.",
      "Second prompts receive the entire object as profileJson plus a readable profileContext summary.",
