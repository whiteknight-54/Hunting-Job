...
import { buildCareerContext } from "./career-context.js";
...
export const buildAtsSubstitutionVariables = (profileData, { jobDescription, questions = "" }) => {
  ...
  const career = buildCareerContext(profileData);
  ...
  return {
    ...
    careerGuidance: career.careerGuidance,
    seniorityArc: career.seniorityArc,
    chronologyRules: career.chronologyRules,
