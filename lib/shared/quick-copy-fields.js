...
export function buildQuickCopyFields(profileData, gdriveFolderId = null) {
  ...
  const lastRole = profileData.experience?.[0]?.title || null;
  ...
  return [
    ...
    { key: "location", label: "Address", value: profileData.location, iconUrl: "https://img.icons8.com/color/96/google-maps-new.png" },
