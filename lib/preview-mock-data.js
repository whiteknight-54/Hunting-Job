...
export const getPreviewMockDataForProfile = (profileData) => {
  ...
  if (profileData.phone) mock.phone = profileData.phone;
  if (profileData.location) mock.location = profileData.location;
  if (profileData.linkedin) mock.linkedin = profileData.linkedin;
  if (profileData.website) mock.website = profileData.website;
