...
export default function TemplatePdfMiniPreview({
  ...
  const profileExtras = () => profileOverrideForApi(profileData, hasProfileOverride);
  ...
  }, [templateId, profileSlug, profileData, hasProfileOverride, profileJobCount, pastedContent, showPhone, showLinkedin]);
