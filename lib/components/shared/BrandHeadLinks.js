...
/**
 * Preload login hero logo (use only on `/` — skip on profile pages).
 */
  ...
  return (
    <>
      <link
        ...
        type={SITE_FAVICON_MIME}
        sizes={`${SITE_FAVICON_WIDTH}x${SITE_FAVICON_HEIGHT}`}
      />
      <link rel="icon" href={SITE_FAVICON_ICO_PATH} sizes="any" />
