...
export const HELP_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      {
        title: "Enter the job description, role title and company",
        body: "Job description, Role Title and Company is required. also feeds the file name when you add it.",
      },
      {
